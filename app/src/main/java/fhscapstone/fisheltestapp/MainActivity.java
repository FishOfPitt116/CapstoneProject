...
public class MainActivity extends AppCompatActivity {
    ...
    public void infoScreen() {
            Button newTeam = (Button) findViewById(R.id.newTeam);
            ...
            Button loadTeam = (Button) findViewById(R.id.loadTeam);
            loadTeam.setOnClickListener(new View.OnClickListener() {
                public void onClick (View v) {
                    startActivity(new Intent(MainActivity.this, LoadTeamList.class));
                }
                                        });
